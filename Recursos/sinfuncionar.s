...
@para que dispare yjugador 1 = 21
@para que dispare yjugador 2 = 12
...
/*----------------------------------------------------------*/
@pinta en pantalla los datos de quien le toca y la municion; cambia el turno ; cambia la ubicacion del disparo
...
restarMunicion:
   .fnstart
      ...
      ldrb r2, [r1]
      sub r2, #1
      strb r2, [r1] @aca actualizamos el valor del disparo en memoria
      bx lr
      restarMunicionJ2:
      ldr r1, =cantDispJ2
      ldrb r2, [r1]
...
asignarTurno:
   .fnstart
      push {lr}
      ldrb r4, [r4] @lo contenido en =turnoJ
	  cmp r4, #1
	  beq juegaJ2
	  b juegaJ1
   cambiarTurno:
...
switchLugarDisparo:
   .fnstart
      ...
      mov r7, #12 @para cambiar en YjugadorTurno
      ...
      ldrb r10, [r10]
      cmp r10, #1
      beq cambiarDisparoAJ2
      cmp r10, #2
      beq cambiarDisparoAJ1
      cambiarDisparoAJ2:
      str r2, [r3]
      str r2, [r4]
      str r2, [r5]
...
resultado:
   .fnstart
     cmp r1, #0
	  ...
	  cmp r2, #0
	  beq gj1
	  cmp r4, #0 @r3 cantidad disparos j1 y r4 cantidad disparos j2
	  beq emp
	  b volver
	gj1:
	   ldr r4, =ganaJ1
